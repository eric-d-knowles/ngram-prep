...
class W2VModel:
    ...
    def compare_models_cosim(self, reference_model, word=None):
        ...
        Returns:
            tuple: (mean_similarity, std_similarity, num_words) or (None, None, None) if no shared words.
        """
        if word:
    ...
    def compute_weat(self, targ1, targ2, attr1, attr2, num_permutations=10000, return_std=False):
        ...
        Args:
            ...
            return_std (bool): Whether to return standard deviation of permuted effect sizes.

        Returns:
            tuple: (weat_effect_size, p_value) or (weat_effect_size, p_value, std_dev) if return_std=True.
        """
