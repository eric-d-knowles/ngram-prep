...
def plot_evaluation_results(
    ...
    if panel_by:
        ...
        if plot_title:
            fig.suptitle(plot_title, fontsize=24, fontweight='bold', y=1.00)
    ...
    try:
        if panel_by and plot_title:
            plt.tight_layout(rect=[0, 0, 1, 0.97], h_pad=3.0)  # Leave space for suptitle and add vertical padding
        elif panel_by:
    ...
    if plot_type == "line":
        if len(x_vars) == 1:
            ...
            ax.set_title(
                ...
                fontsize=16 if is_panel else 14
            )
