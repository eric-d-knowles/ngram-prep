...
from ngram_acquire.io.locations import set_location_info, BASE_URL
...
def test_builds_correct_url_and_regex():
    ...
    # Filenames do not include the corpus prefix; they are "<n>-xxxxx-of-xxxxx.gz"
    assert rx.fullmatch("2-00001-of-00024.gz")
    assert not rx.fullmatch("eng-us-2-00001-of-00024.gz")  # corpus prefix not part of filename
    assert not rx.fullmatch("3-00001-of-00024.gz")         # wrong n
